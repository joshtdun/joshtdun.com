...
class SuccessfulPasswordResetTests(TestCase):
    def setUp(self):
        email = 'josh@doe.com'
        User.objects.create_user(username='josh', email=email, password='123abcdef')
        url = reverse('password_reset')
...
class PasswordResetConfirmTests(TestCase):
    def setUp(self):
        user = User.objects.create_user(username='josh55', email='josh55@doe.com', password='123abcdef')
